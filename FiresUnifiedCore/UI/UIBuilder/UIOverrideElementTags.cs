...
{
    /// <summary>
    /// Tags that tell the override wiring what an injected element is, checked before any name-based guess. Set in the
    /// UI Builder inspector or during capture, and usable by other mods to find override elements such as equipment
    /// slots, the quick-access bar or side panels.
    /// </summary>
